      ...
      <section id="process" className="py-15 relative overflow-hidden" ref={ref}>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="relative">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 relative">
              {steps.map((item, index) => (
                ...
                >
                  <Card className="text-center p-4 lg:p-6 h-full border-2 border-transparent group-hover:border-accent/20 transition-all duration-300 bg-background hover:shadow-lg">
                    <CardContent className="space-y-4 p-0">
                      ...
                      <h3 className="font-semibold text-base lg:text-lg text-balance leading-tight">{item.title}</h3>
